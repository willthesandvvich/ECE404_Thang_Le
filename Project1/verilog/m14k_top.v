...
//wire [1:0] processor_id;
	parameter M14K_INSTNUM = 0;              // instance number. 



		input  [1:0] PROCESSOR_NUM;    //Number of Processor ,in
		output [1:0] PROCESSOR_ID;	//processor ID , output
...
assign PROCESSOR_ID = PROCESSOR_NUM;
...
parameter RESET_VECTOR = 12'h0;

    m14k_cpu #(.RESET_VECTOR(RESET_VECTOR)) cpu (
	.BistIn(BistIn),
	.BistOut(BistOut),
